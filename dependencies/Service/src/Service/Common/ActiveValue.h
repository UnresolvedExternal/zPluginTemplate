...
namespace Service
{
	...
	public:
		...
		inline ActiveValue(const ActiveValue& other);
		...
		inline ActiveValue& operator=(const ActiveValue& other);
...
namespace Service
{
	...
	template <typename T>
	ActiveValue<T>::ActiveValue(const ActiveValue& other) :
		value{ other.value }
	{
	...
	template <typename T>
	ActiveValue<T>& ActiveValue<T>::operator=(const ActiveValue& other)
	{
		*this = other.value;
		return *this;
	}
